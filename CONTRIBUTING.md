...
Open a [GitHub issue](https://github.com/apivault-labs/job-posting-lead-finder-python/issues)
with:
- Python version (`python --version`)
- SDK version (`pip show job-posting-lead-finder`)
...
- **New extracted fields** (more skills patterns, new derived metrics) — those live in
  the underlying Apify actor; open an issue and we'll discuss

## Development setup

```bash
git clone https://github.com/apivault-labs/job-posting-lead-finder-python.git
cd job-posting-lead-finder-python
python -m venv .venv
